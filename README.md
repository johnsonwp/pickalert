...
Wirepick built the app app as a Free app. This SERVICE is provided by team effort at no cost and is intended for use as is.
...
For a better experience, while using our Service, We may require you to provide us with certain personally identifiable information, including but not limited to Phone Numbers, Mobile Device IMEI(mobile equipment identity) Number. The information that we request is retained on your device and used to provide the service. 
